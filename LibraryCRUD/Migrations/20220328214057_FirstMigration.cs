    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Client_Book", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Client_Book_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Client_Book_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_Book_BookId",
                table: "Client_Book",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Client_Book_ClientId",
                table: "Client_Book",
                column: "ClientId");
        }
